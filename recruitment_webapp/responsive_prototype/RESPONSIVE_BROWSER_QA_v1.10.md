# Responsive Browser QA v1.10

**TOTAL=108 PASS=108 FAIL=0**

Executed against the effective load chain through `responsive-v110.js` using headless Chromium.

| Result | Check | Detail |
|---|---|---|
| PASS | Responsive README/VERSION authority v1.10 + Full v1.17 |  |
...
| PASS | RP-COPY-01 Copy fills empty target Round1 | {'count': 1, 'no': 1, 'topic': '', 'date': '15/05/2025', 'start': '09:00', 'end': '10:00', 'location': 'Phòng Kỹ thuật 201 – EIU', 'prov': 'r11'} |
| PASS | RP-COPY-03 Copy keeps Demo Topic blank | {'count': 1, 'no': 1, 'topic': '', 'date': '15/05/2025', 'start': '09:00', 'end': '10:00', 'location': 'Phòng Kỹ thuật 201 – EIU', 'prov': 'r11'} |
| PASS | RP-COPY-04 Copy preserves source schedule logistics | {'count': 1, 'no': 1, 'topic': '', 'date': '15/05/2025', 'start': '09:00', 'end': '10:00', 'location': 'Phòng Kỹ thuật 201 – EIU', 'prov': 'r11'} |
...
| PASS | RP-COPY-02 Copy used target Round1 creates next legal round | {'count': 2, 'r1Topic': 'Already used', 'r2No': 2, 'r2Topic': '', 'date': '15/05/2025', 'start': '09:00', 'end': '10:00', 'location': 'Phòng Kỹ thuật 201 – E... |
...
| PASS | Create blocks inactive selected Participant | 10->10 CURRENT_PARTICIPANT_INACTIVE_REASSIGN_REQUIRED: TS. Trần Minh Khoa |
...
| PASS | RQA-SCH-STATUS-01 single inactive Participant blocks | {'status': 'CANCELLED', 'last': {'roundIds': ['r41'], 'targetStatus': 'SCHEDULED', 'ok': False, 'failures': [{'roundId': 'r41', 'code': 'CURRENT_PARTICIPANT_... |
| PASS | RQA-SCH-STATUS-02 bulk inactive Participant rolls back all | {'r41': 'CANCELLED', 'r31': 'CANCELLED', 'last': {'roundIds': ['r41', 'r31'], 'targetStatus': 'SCHEDULED', 'ok': False, 'failures': [{'roundId': 'r41', 'code... |
| PASS | RQA-SCH-STATUS-03 single Candidate conflict blocks | {'status': 'CANCELLED', 'last': {'roundIds': ['r12'], 'targetStatus': 'SCHEDULED', 'ok': False, 'failures': [{'roundId': 'r12', 'code': 'SCHEDULE_CONFLICT', ... |
| PASS | RQA-SCH-STATUS-04 single Room conflict blocks | {'status': 'CANCELLED', 'last': {'roundIds': ['r41'], 'targetStatus': 'SCHEDULED', 'ok': False, 'failures': [{'roundId': 'r41', 'code': 'SCHEDULE_CONFLICT', ... |
| PASS | RQA-SCH-STATUS-05 single Interviewer conflict blocks | {'status': 'CANCELLED', 'last': {'roundIds': ['r41'], 'targetStatus': 'SCHEDULED', 'ok': False, 'failures': [{'roundId': 'r41', 'code': 'SCHEDULE_CONFLICT', ... |
| PASS | RQA-SCH-STATUS-06 bulk conflict rolls back every selected Interview | {'r41': 'CANCELLED', 'r31': 'CANCELLED', 'last': {'roundIds': ['r41', 'r31'], 'targetStatus': 'SCHEDULED', 'ok': False, 'failures': [{'roundId': 'r41', 'code... |
| PASS | RQA-SCH-STATUS-07 adjacent activation allowed | {'status': 'SCHEDULED', 'last': {'roundIds': ['r41'], 'targetStatus': 'SCHEDULED', 'ok': True, 'failures': []}} |
