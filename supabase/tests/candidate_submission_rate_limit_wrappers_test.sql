...
begin
  ...
  assert not pg_catalog.has_function_privilege(
    'authenticated',
    'public.submit_candidate_submission(uuid,text,text,date,text,text,text,jsonb,jsonb,jsonb,text,uuid)',
    'EXECUTE'
  ), 'authenticated must not execute legacy submit RPC';
  assert not pg_catalog.has_function_privilege(
    'authenticated',
    'public.update_candidate_submission(uuid,text,text,date,text,text,text,jsonb,jsonb,jsonb,text,uuid)',
    'EXECUTE'
  ...
  assert not pg_catalog.has_function_privilege(
    'authenticated',
    'public.submit_candidate_submission_rate_limited(uuid,text,text,uuid,text,text,date,text,text,text,jsonb,jsonb,jsonb,text,uuid)',
    'EXECUTE'
  ), 'authenticated must not execute submit limiter wrapper';
  assert not pg_catalog.has_function_privilege(
    'authenticated',
    'public.update_candidate_submission_rate_limited(uuid,text,uuid,text,text,date,text,text,text,jsonb,jsonb,jsonb,text,uuid)',
    'EXECUTE'
  ...
  assert pg_catalog.pg_get_functiondef(
    'public.submit_candidate_submission_rate_limited(uuid,text,text,uuid,text,text,date,text,text,text,jsonb,jsonb,jsonb,text,uuid)'::regprocedure
  ...
  assert pg_catalog.pg_get_functiondef(
    'public.update_candidate_submission_rate_limited(uuid,text,uuid,text,text,date,text,text,text,jsonb,jsonb,jsonb,text,uuid)'::regprocedure
  ) like '%''limit'', 30%',
